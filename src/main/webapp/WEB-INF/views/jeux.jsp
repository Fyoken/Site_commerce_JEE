...
<div id="entete">
	...
	<nav>
		<ul class="menu">
            ...
            <tr><td width="30%"><br><br> <img src="pokemon.png"  /></a></td>
            <td width="5%" align="center"> 59.99€</td>
            <td width="20%" align="center" >
            <button onclick="ajouter(${userId},5)"> Ajouter </button>
</div>
</tr>
            <tr><td><br><br><img src="gow.png"  /></a></td>
            <td align="center"> 79.99€</td>
            <td width="20%" align="center" > 
            <button onclick="ajouter(${userId},6)"> Ajouter </button>
</div>
</tr>
           <tr><td width="30%"><br><br><img src="cod.png"  /></a></td>
           <td width="5%" align="center"> 62.99€</td>
           <td width="20%" align="center">
           <button onclick="ajouter(${userId},7)"> Ajouter </button>
</div></tr>
           <tr><td width="30%"><br><br><img src="mario.png"  /></a></td>
           <td width="5%" align="center"> 20€</td>
           <td width="20%" align="center">
           <button onclick="ajouter(${userId},8)"> Ajouter </button>
	</div></tr>
        </tr>
    </tbody>
</table>
