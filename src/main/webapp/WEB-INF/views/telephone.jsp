...
<html>
	...
	<div id="entete">
		...
		<nav>
            ...
            <tr><td width="30%"><br><br> <img src="huawey.png" /></a></td>
            <td width="5%" align="center"> 223,99€</td>
            <td width="20%" align="center" >
            <button onclick="ajouter(${userId},1)"> Ajouter </button>
</div>
</tr>
            <tr><td><br><br><img src="iphone.png" /></a></td>
            <td align="center"> 2129€</td>
            <td width="20%" align="center" > 
            <button onclick="ajouter(${userId},2)"> Ajouter </button>
</div>
</tr>
           <tr><td width="30%"><br><br><img src="pocoPhone.png" /></a></td>
           <td width="5%" align="center"> 399.99€</td>
           <td width="20%" align="center">
           <button onclick="ajouter(${userId},3)"> Ajouter </button>
</div></tr>
           <tr><td width="30%"><br><br><img src="samsung.png" /></a></td>
           <td width="5%" align="center"> 459.90€</td>
           <td width="20%" align="center">
           <button onclick="ajouter(${userId},4)"> Ajouter </button>
	</div></tr>
        </tr>
    </tbody>
</table>
