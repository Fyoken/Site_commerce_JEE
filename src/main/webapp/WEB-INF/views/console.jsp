...
<div id="entete">
	...
	<nav>
		<ul class="menu">
            ...
            <tr><td width="30%"><br><br> <img src="Switch.png" /></a></td>
            <td width="5%" align="center"> 311.99€</td>
            <td width="20%" align="center" >
				<button onclick="ajouter(${userId},9)"> Ajouter </button>
</div>
</tr>
            <tr><td><br><br><img src="playstation.png" /></a></td>
            <td align="center"> 499€</td>
            <td width="20%" align="center" > 
				<button onclick="ajouter(${userId},10)"> Ajouter </button>
</div>
</tr>
           <tr><td width="30%"><br><br><img src="XBOX.png" /></a></td>
           <td width="5%" align="center"> 299.99€</td>
           <td width="20%" align="center">
			   <button onclick="ajouter(${userId},11)"> Ajouter </button>
</div></tr>
           <tr><td width="30%"><br><br><img src="nintendo.png" /></a></td>
           <td width="5%" align="center"> 49.99€</td>
           <td width="20%" align="center">
			   <button onclick="ajouter(${userId},12)"> Ajouter </button>
	</div></tr>
        </tr>
    </tbody>
</table>
