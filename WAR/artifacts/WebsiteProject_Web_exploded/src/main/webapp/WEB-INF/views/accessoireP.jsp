...
<div id="entete">
	...
	<nav>
		<ul class="menu">
            ...
            <tr><td width="30%"><br><br> <img src="/souris.png" /></a></td>
            <td width="5%" align="center"> 189.99€</td>
				<td width="20%" align="center" >
					<button onclick="ajouter(${userId},21)"> Ajouter </button>
			</div>
</tr>
            <tr><td><br><br><img src="/clavier.png" /></a></td>
            <td align="center"> 149.99€</td>
				<td width="20%" align="center" >
					<button onclick="ajouter(${userId},22)"> Ajouter </button>
</div>
</tr>
           <tr><td width="30%"><br><br><img src="/tapis.png" /></a></td>
           <td width="5%" align="center"> 137.99€</td>
			   <td width="20%" align="center">
				   <button onclick="ajouter(${userId},23)"> Ajouter </button>
</div></tr>
           <tr><td width="30%"><br><br><img src="/casque.png" /></a></td>
           <td width="5%" align="center"> 41.99€</td>
			   <td width="20%" align="center">
				   <button onclick="ajouter(${userId},24)"> Ajouter </button>
	</div></tr>
        </tr>
    </tbody>
</table>
